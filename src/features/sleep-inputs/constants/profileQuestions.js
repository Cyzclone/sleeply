...
export const PROFILE_QUESTIONS = [
  ...
  {
    id: "stressLevel",
    label: "How stressed are you? (0-10)",
    min: 0,
    max: 10,
    step: 1,
  },
  ...
  {
    id: "sleepConsistency",
    label: "How consistent has your sleep been in the last week? (0-10)",
    min: 0,
    max: 10,
    step: 1,
  },
  {
    id: "environmentLevel",
    label: "How disruptive is your sleep environment? (temperature, noise, comfort) (0-10)",
    min: 0,
    max: 10,
    step: 1,
  },
  {
    id: "alcoholLevel",
    label: "How much alcohol is in your system? (0-10)",
    min: 0,
    max: 10,
    step: 1,
  },
  {
    id: "caffeineLevel",
    label: "How much caffeine is in your system? (0-10)",
    min: 0,
    max: 10,
    step: 1,
  },
  {
    id: "cannabisLevel",
    label: "How much cannabis is in your system? (0-10)",
    min: 0,
    max: 10,
    step: 1,
  },
